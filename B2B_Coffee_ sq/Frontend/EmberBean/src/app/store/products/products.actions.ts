...
export const loadProducts = createAction('[Products] Load Products', props<{ params?: any }>());
...
export const createProduct = createAction('[Products] Create Product', props<{ product: CreateProductRequest }>());
...
export const updateProduct = createAction('[Products] Update Product', props<{ id: string; product: UpdateProductRequest }>());
