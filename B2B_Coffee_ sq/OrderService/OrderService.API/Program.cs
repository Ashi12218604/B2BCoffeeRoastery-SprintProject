...
builder.Services.AddScoped<IDemoPaymentService, OrderService.Infrastructure.Services.DemoPaymentService>();
...
builder.Services.AddMassTransit(x =>
{
    ...
    x.AddSagaStateMachine<OrderFulfillmentSaga, OrderSagaState>()
        .EntityFrameworkRepository(r =>
        {
            ...
            r.AddDbContext<DbContext, OrderDbContext>((sp, o) =>
                o.UseSqlServer(
                    builder.Configuration.GetConnectionString("OrderDb"),
                    so => so.UseQuerySplittingBehavior(QuerySplittingBehavior.SplitQuery)));
        });
